export const config = {
  ...
  headerNav: [
    ...
    { linkLabel: "NFT", linkUrl: "#nft" },
    { linkLabel: "About", linkUrl: "#about" },
    { linkLabel: "How to buy", linkUrl: "#buy" },
    { linkLabel: "Community", linkUrl: "#community" },
  ],
  footerNav: [
    { linkLabel: "Overview", linkUrl: "" },
    { linkLabel: "Features", linkUrl: "" },
    { linkLabel: "Help", linkUrl: "" },
    { linkLabel: "Privacy", linkUrl: "" },
  ],
  footerLinks: [
    { linkLabel: "Term Of Service", linkUrl: "" },
    { linkLabel: "Policy Service", linkUrl: "" },
